...
values (10000, 'работы', 'аванс за стены', '2010-03-03', 'Черновые работы', 1, 1),
       (5000, 'материалы', ' оплата за штукатурку', '2010-03-10', 'Черновые работы', 1, 1),
       (5000, 'работы', ' аванс за электрику', '2010-03-10', 'Электрика', 2, 1),
       (181.5, 'материалы', ' оплата за подрозетники', '2010-03-10', 'Электрика', 2, 1);
...
values ('работы', true, 3000.0, 3600.0, 'Грунтовка стен', 30.0, 36.0, 100.0, 'м2', 1),
       ...
       ('материалы', true, 21600, 23700, 'Штукатурка Волма-слой', 400.0, 440.0, 54, 'м2', 1),
       ('работы', false, 15000.0, 18000.0, 'Электроточки', 500.0, 550.0, 30.0, 'шт', 2),
       ('материалы', true, 165.0, 181.5, 'Подрозетники', 5.5, 6.05, 30.0, 'шт', 2);
